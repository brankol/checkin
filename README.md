# A scrum checkin app using the Universal React Boilerplate

[![Travis-CI](https://travis-ci.org/brankol/checkin.svg?branch=master)](https://travis-ci.org/brankol/checkin)
